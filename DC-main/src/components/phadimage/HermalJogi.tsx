    ...
    <>
      ...
      <Dialog open={showAnimations} onOpenChange={setShowAnimations}>
        <DialogContent className="sm:max-w-lg">
          <DialogHeader>
            <DialogTitle>Hermal Jogi</DialogTitle>
            <DialogDescription>
            Hermal Jogi: One of the most famous stories features Harmal transforming into a Jogi, or ascetic, to infiltrate enemy territory. Disguised and unnoticed, he gathers crucial intelligence about the camels’ positions in Lanka, showcasing his cunning and resourcefulness. 
            </DialogDescription>
          </DialogHeader>
          <button
      ...
      {/* Trigger Button */}
      <motion.button
        className="absolute top-[60%] left-[59%] cursor-pointer z-[50] rounded-full w-4 h-4 bg-blue-500  "
